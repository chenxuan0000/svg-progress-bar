<template>
    <div id="app">
        <div class="fixed top-0 w-100 z-1 flex-none flex flex-row items-center pv3 ph4 bg-blue white">
            <div class="flex-none"><a href="https://github.com/chenxuan0000/vue-progress-bar" rel="noopener"
            ...
            <div class="flex-none" style="margin-left: 10px;"><a
                    href="https://github.com/chenxuan0000/vue-progress-bar"
                    class="white no-underline underline-hover">vue-progress-bar</a></div>
        </div>
            ...
            <div class="mb5 center" style="max-width: 57rem">
                <div class="pt5 nb5" id="default-spinners">
                    <a href="#default-spinners" :class="header_cls">
                        <h2 class="ma0 pb2 f2 fw4 lh-1">Default vue-progress-bar</h2>
                        <p class="ma0 lh-copy f6">
                            vue-progress-bar can be used with no configuration or very little configuration.</p>
                    </a>
